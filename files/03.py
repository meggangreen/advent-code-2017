""" My idea was to have a node class with the cardinal directions and previous
    and next and it was complicated and I couldn't code it out.

    The code below, which I could not replicate, is copied from @mikasjp:
    https://github.com/mikasjp/adventofcode2017/blob/master/03/solution.py
